        ...
        return ( 
            <form onSubmit={(e) => this.handleContactFormSubmit(e)}>
                ...
                <div className="flex-row align-items-center justify-content-space-bet">
                    ...
                    <button type="submit" value="Submit" className="primary-background translate-x-5-parent width-150px flex-row align-items-center justify-content-center translate-y-2 ver-pad-8 color-white bor-radius-30 cursor-pointer box-shadow-2">Send <span className="mar-left-5 translate-x-5">&#8594;</span></button>
                </div>
            </form>
        );
    }
